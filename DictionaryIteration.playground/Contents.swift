...
var bandAndAlbumDictionary = ["Nirvana" : "Nevermind",
...
bandAndAlbumDictionary["Pixies"] = "Doolittle"
print("\(bandAndAlbumDictionary)")
 ...
 */
// write your code here
bandAndAlbumDictionary.removeValueForKey("The Kinks")
print("\(bandAndAlbumDictionary)")
...
// write your code here
if let bandTopSellingAlbum = bandAndAlbumDictionary[bandName] {
    print("\(bandName)'s top-selling album was \(bandTopSellingAlbum).")
}
 ...
 */
// write your code here
for (band, topSellingAlbum) in bandAndAlbumDictionary {
...
// A tuple with elements of keys and values are returned when iterating over a dictionary.
 ...
 */
// We could create a dictionary consisting of keys with Int data types for each grade and values with String data types for each letter grade.
 ...
 */
// write your code here
for (grade, score) in gradeAndLetters {
